...
DESCRIPTION="Messanger Plugins for Verlihub"
...
pkg_postinst() {
	einfo "Messanger plugin is now installed, please run it using !onplug msg or!plugin /usr/local/lib/libmessanger_pi.so"
