...
DESCRIPTION="Chatroom plugins for Verlihub"
...
pkg_postinst() {
	einfo "Chatroom plugin is now installed, please run it using !onplug chat or!plugin /usr/local/lib/libchatroom_pi.so"
